...
class _MyStepperState extends State<MyStepper> with TickerProviderStateMixin {
  ...
  Color _circleColor(int index) {
    ...
    if (!_isDark()) {
      return widget.steps[index].isActive ? (widget.currentStep == index ? Colors.pink : colorScheme.primary) : colorScheme.onSurface.withOpacity(0.38);
    } else {
      return widget.steps[index].isActive ? (widget.currentStep == index ? Colors.pink : colorScheme.secondary) : colorScheme.background;
    }
  }
